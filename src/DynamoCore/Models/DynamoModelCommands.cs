...
namespace Dynamo.Models
{
    partial class DynamoModel
    {
        ...
        internal void OpenFileImpl(OpenFileCommand command)
        {
        ...
        internal void ConvertNodesToCodeImpl(ConvertNodesToCodeCommand command)
        {
        ...
        internal void SwitchTabImpl(SwitchTabCommand command)
        {
